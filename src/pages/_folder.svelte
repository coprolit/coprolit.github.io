...
<nav class="shadow border-bottom padding-sides">
  ...
  <a href={$url('/feedback')} class="bg-accent padding color-light" class:active={$isActive('/feedback')}>
    Feedback?
  </a>

  <a href="https://github.com/coprolit/coprolit.github.io" title="GitHub repo" style="color: #959da5;">
